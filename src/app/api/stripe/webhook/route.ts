...
export async function POST(req: NextRequest) {
  ...
  const webhookSecret =
//   webhook live only available when production
  ...
  // when production there will be two our endpoint , not created 
//   create another endpoint
//   one api for accept agency subscription
// one only for acceot connected account or subaccount  
  try {
